...
@section('content')
    <div class="container pt-5">
        <div class="row">
                                ...
                                <div class="card h-100 border-0">
                                    <div class="card-img-top h-100">
                                        @if(!is_null($product->image_path))
                                            <img src="{{ asset('storage/' . $product->image_path) }}" class="img-fluid mx-auto d-block h-100" alt="Zdjęcie produktu">
                                        @endif
                                    </div>
            ...
            <form class="col-md-4 order-md-1 col-lg-3 sidebar-filter form_filter">
                ...
                @foreach($categories as $category)
                    <div class="mt-2 mb-2 pl-2">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input m-lg-1" name="filter[categories][]" id="category-{{$category->id}}" value="{{$category->id}}">
