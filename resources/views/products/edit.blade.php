                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('products.update',  $product->id )}}" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                <label for="amount" class="col-md-4 col-form-label text-md-end">Ilosc</label>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="price" type="number" step="0.01" class="form-control @error('price') is-invalid @enderror" name="price" value="{{ $product->price }}" required autocomplete="price">
                            ...
                            <div class="row justify-content-center ">
                                <img src="{{asset('storage/'. $product->image_path)}}" class="w-25 h-25" alt="Zdjęcie">
                            </div>
                            <div class="row mb-0">
